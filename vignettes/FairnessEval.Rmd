...
2. Clinical data from the MIMIC-II database for a case study on indwelling arterial catheters v1.0. https://physionet.org/content/mimic2-iaccd/1.0/ (2016).

3. Gronsbell, J. L. & Cai, T. Semi-Supervised approaches to efficient evaluation of model prediction performance. Journal of the Royal Statistical Society Series B (Statistical Methodology) 80, 579–594 (2017).

4. Efron, B. & Tibshirani, R. Bootstrap methods for standard errors, confidence intervals, and other measures of statistical accuracy. Statistical Science 1, (1986).
