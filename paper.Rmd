...
<!-- The figure looks good but do not use any abbreviations (i.e., Predicted probabilities).  Also, we use "protected" not sensitive attribute in paper so update.  Also add negative predictive parity once added to the package. For combined: What's the difference between get_all and get_fairness?  -->
