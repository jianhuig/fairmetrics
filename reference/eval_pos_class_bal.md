...
This function evaluates *Balance for the Positive Class*, a fairness
criterion that checks whether the model assigns similar predicted
probabilities among individuals whose true outcome is positive (i.e. \\Y
= 1\\) accross groups defined by a binary protected attribute.
...
[`eval_neg_class_bal`](eval_neg_class_bal.md)
